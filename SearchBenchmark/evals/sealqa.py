"""SealQA eval — SEarch-Augmented Language models on challenging QA.

Reference: https://huggingface.co/datasets/vtllms/sealqa
Data: references/sealqa/ (parquet files - git lfs placeholders, need HuggingFace download)
"""
