...
pub fn build_app() -> Router {
    ...
    let app = Router::new()
        ...
        .route("/api/thumbnails/batch", post(handlers::start_thumbnail_batch))
        .route("/api/thumbnails/batch/:job_id", get(handlers::get_thumbnail_job))
        .route("/api/thumbnails/batch/:job_id/cancel", post(handlers::cancel_thumbnail_job))
